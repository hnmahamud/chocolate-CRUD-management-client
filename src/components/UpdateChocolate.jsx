...
const UpdateChocolate = () => {
  const singleChocolate = useLoaderData();
  ...
  const handleSubmit = (event) => {
    ...
    const updateChocolate = { name, price, categoryValue, photo };
    ...
    fetch(
      `https://chocolate-management-server-hnmahamud.vercel.app/chocolates/${_id}`,
      options
    )
    ...
    <div className="w-[95%] md:w-[80%] mx-auto mt-12">
      ...
      <div className="bg-gray-200 py-12 rounded-md space-y-8">
        <div className="text-center">
          <h3 className="text-2xl font-semibold">Update Chocolates</h3>
          <p className="text-gray-500">
            Use the below form to update your chocolates
          </p>
        </div>
        <form
